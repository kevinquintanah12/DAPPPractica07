En esta practica se realizó un crud de empleados en java con base de datos potgres, esta es la segunda fase de la práctica, en donde se junta el backend hecho en DAPPPractica06 con esta nueva parte en donde,
con lo ya realizado se anexa un front con tecnología a nuestra elección (en este caso la escogida sería Angular), juntando estos para que el frontend en angular funcione en base al back realizado.

Muestra 1. Backend en Java iniciado.
<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/b4e15ddf-39eb-404c-9167-7e08d35ee4ce" />

Muestra 2. Frontend iniciado.
